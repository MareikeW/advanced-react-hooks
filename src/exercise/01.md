...
--> Gut mit Switch-Statement, um die verschiedenen Aktionen aufzulisten und als default einen Error zu werfen: throw new Error(`Unupported action type: ${action.type}`)
